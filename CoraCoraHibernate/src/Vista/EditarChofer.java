 ...
 */
public class EditarChofer extends javax.swing.JInternalFrame {
    int numero;
    String dni;
    /**
     * Creates new form EditarChofer
     */
    public EditarChofer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        LabelTitulo.setText("CAMBIAR CHOFER");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
                        ...
                        String consultaOracle = "DELETE FROM CHOFERES WHERE DNI_CHOFER = '"+dni+"'";
                        if(numero==1){
                        consultaOracle1 = "UPDATE VEHICULOS SET DNI_CHOFER = '"+dnichofer.getText()+"' WHERE PLACA_VEHI= '"+Inicio.f7.getcampoplaca()+"'";
                        }
                        if(numero==2){
                        consultaOracle1 = "UPDATE VEHICULOS SET DNI_CHOFER = '"+dnichofer.getText()+"' WHERE PLACA_VEHI= '"+GestorAsociados.f7.getcampoplaca()+"'";
                        }
                        String consultaOracle2 = "INSERT INTO CHOFERES(DNI_CHOFER,NOM_CHOFER,APE_CHOFER) VALUES('"+dnichofer.getText()+"','"+nomchofer.getText()+"','"+apechofer.getText()+"')";
                        ...
                        JOptionPane.showMessageDialog(this, "Chofer modificado correctamente");
                        this.setVisible(false);
                        if(numero==1){
                            Inicio.f8.setnumero(1);
    ...
    public void seter(){
        ...
        dnicobra.setEnabled(false);
        nomcobra.setText(Inicio.f8.nomcobrador);
        nomcobra.setEnabled(false);
        apecobra.setText(Inicio.f8.apecobrador);
        apecobra.setEnabled(false);
        dni=dnichofer.getText();
        }
        if(numero==2){
